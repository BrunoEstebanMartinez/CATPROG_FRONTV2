...
export const useCheckAuth = () => {
    ...
    useEffect( () => {
            ...
            const { id, name, email, profile, first_time, acceso_tipo, dependencia } = user;

            // console.log(user);

            // aqui 

            return dispatch( login({ id, name, email, profile, first_time, token, acceso_tipo, dependencia }) );
