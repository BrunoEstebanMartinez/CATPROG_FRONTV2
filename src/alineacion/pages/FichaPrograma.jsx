...
export const FichaPrograma = () => {
  ...
  function SetStatePrograma(prog_id, periodo_id){
        dispatch(onDispatchInfoPrograma(prog_id, periodo_id));  
  }
                      ...
                      <tbody id = 'onGetChanged' data-table1 =''>
                            ...
                            {   programa?.map( ({periodo_id, clasificgob_desc, nombre_completo, prog_id, prog_desc, prog_verti}, i) => {
                                ...
                                return  <>
                                    ...
                                    <td>
                                        <Link type="button" title="eye" className="flex justify-center" to = "fichaglobal" onClick={() => {localStorage.setItem("isObjectInfo", JSON.stringify([prog_id, periodo_id]))}}>
